<template>
  ...
  >
    ...
    <div class="flex justify-center w-full max-w-5xl mx-auto flex-grow-0">
      Designed and built with

      <a href="https://strapi.com" target="_blank" rel="noopener">
        <img
          src="@/assets/img/logos/strapi-logo-light.svg"
          alt="Strapi Logo"
          class="logo mx-2"
          height="85"
          width="85"
      ...
      by
      <a href="https://threebros.design" target="_blank" rel="noopener">
        <img
          src="@/assets/img/logos/TreeBros-logo.svg"
          alt="TreeBros Logo"
          class="logo mx-2"
          height="85"
          width="85"
