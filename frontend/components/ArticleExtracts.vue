<template>
  ...
  >
    ...
    >
      <h3
        class="font-semibold text-gray-800 mt-4 hover:underline text-lg dark:text-gray-50"
      >
          ...
          <p v-if="article.article_categories.length > 0" id="categories">
            <span class="text-xs">
              ...
              <NuxtLink
                ...
                class="capitalize text-gray-500 font-light rounded bg-gray-200 px-2 py-1 mx-1 dark:bg-gray-700 dark:text-gray-300"
              >
                {{ cat.category }}
              </NuxtLink>
            </span>
