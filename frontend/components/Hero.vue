      ...
      <div class="px-4 md:block">
        <div class="pb-8 mt-auto">
          <div class="text-center">
            ...
            >
              The Progressive Python
              <span class="text-indigo-600">Framework</span> For Trading
              Cryptocurrencies
            </h1>

            <div class="md:max-w-2xl mx-auto">
              <p class="text-gray-800">
                Jesse is not merely another bot. It is a framework focusing on
                helping you develop your very own trading strategies.
              </p>
            </div>
